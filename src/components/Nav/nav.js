...
const DesktopLinkItem = tw.div`border-b-2 border-transparent hocus:text-primary hocus:border-primary pb-1 transition duration-300 p-1 font-medium text-gray-900 lg:p-6 sm:p-4 font-secondary cursor-pointer`;
      ...
      <DesktoplinksWrapper>
        <DesktoplinksWrapperUnder>
          ...
          <div>
            <DesktopLink>
              <Link href="#" passHref>
                <DesktopLinkItem>Organisation</DesktopLinkItem>
              </Link>
            </DesktopLink>
          </div>
          <div>
